...
CALLINGYAML="~/mutect2-pon-cwl/workflows/mutect2-pon-workflow.cwl.yaml" # -y
SNPPATH="~/mutect_ref_files/dbsnp_144.grch38.vcf"                       # -s
FAIPATH="~/mutect_ref_files/Homo_sapiens_assembly38.fa.fai"             # -i
DICTPATH="~/mutect_ref_files/Homo_sapiens_assembly38.dict"              # -k
COSMICPATH="~/mutect_ref_files/CosmicCombined.srt.vcf";                 # -x
